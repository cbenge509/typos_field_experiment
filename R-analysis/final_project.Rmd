...
stargazer(model_ucb_treatment,
          se = list(sqrt(diag(vcovHC(model_ucb_treatment, type = "HC1")))), type="html", column.labels = c("Baseline"))
```
...
stargazer(model_ucb_treatment, model_ucb_treatment_demo,
          se = list(sqrt(diag(vcovHC(model_ucb_treatment, type = "HC1"))),
                    sqrt(diag(vcovHC(model_ucb_treatment_demo, type = "HC1")))), type="html", column.labels = c("Baseline","Demographics"))
```
